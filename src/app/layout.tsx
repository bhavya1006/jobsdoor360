...
export const metadata: Metadata = {
  title: 'JobsDoor360 - Your Career Gateway',
  description: 'Find your next career opportunity with JobsDoor360. We connect talent with the best job and business options.',
};
