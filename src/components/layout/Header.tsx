...
const careerOptions: { title: string; href: string; description: string }[] = [
  ...
  },
  {
    ...
    description: "Browse current job openings.",
  },
  {
  ...
  },
  {
    ...
    description: "Analyze your professional profile.",
  },
];
...
const blogOptions: { title: string; href: string }[] = [
  ...
  {
    title: "Wealthy Healthy Satisfactory Life",
    href: "/blog/wealthy-healthy-and-satisfactory-life",
  },
];
              ...
              <SheetContent side="right" className="w-full max-w-sm">
                <div className="flex flex-col h-full">
                  ...
                  <nav className="flex-1 flex flex-col p-4 space-y-2 overflow-y-auto">
                    <SheetClose asChild>
                      <Link className="py-2 text-lg" href="/">
                        Home
                      </Link>
                    </SheetClose>
                    ...
                    <SheetClose asChild>
                      <Link className="py-2 text-lg" href="/job-analysis">
                        Job Analysis
                      </Link>
                    </SheetClose>
                    ...
                    <SheetClose asChild>
                      <Link className="py-2 text-lg" href="/assessments">
                        Assessments
                      </Link>
                    </SheetClose>
                    <SheetClose asChild>
                      <Link className="py-2 text-lg" href="/about">
                        About Us
                      </Link>
                    </SheetClose>
                    <SheetClose asChild>
                      <Link className="py-2 text-lg" href="/apply">
                        Apply Now
                      </Link>
                    </SheetClose>
                  </nav>
